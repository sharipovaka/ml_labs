...
const REFERENCE = [
  {
    ...
    description:
      'Минимум, на котором держится практикум: база Python, NumPy, pandas, графики и единый интерфейс scikit-learn — 37 пунктов, собранных по коду занятий, поэтому список закрытый. Восемь вопросов на проверку себя с ответами под спойлером и путь из трёх шагов для тех, у кого пробелы.',
    date: '2026-09-03',
