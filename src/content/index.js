...
export const labSessions = [
  {
    ...
    description:
      'Векторизация в NumPy вместо циклов. Разбор «Титаника»: смотрим на данные глазами, и карта корреляций сама находит утечку (alive совпадает с ответом) и признаки-дубликаты; сколько стоит dropna(); типы признаков и кодирование; разбиение без утечек и константный ориентир.',
    date: '2026-09-03',
